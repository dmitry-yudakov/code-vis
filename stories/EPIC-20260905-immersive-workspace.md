...
evidence for CodeAI's own checkout, in three parts; Part A, which lists them in CodeAI's own project,
is implemented. Draft Story 64 then adds an explicitly approved managed rebuild/restart loop and
