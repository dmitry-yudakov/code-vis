...
export function SpatialRoom({
  session, theme, activeId, spatial, onSelect, onOpenFlat, onViewChange, onReset, onFailure,
}: SpatialRoomProps) {
  ...
  const { resources, loading } = usePanelResources(selectedTargets, session, activeId, theme);
