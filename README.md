...
`CODEAI_PROJECTS_DEPTH` (default 1, maximum 10). The header project picker shows the active
...
- `CODEAI_PROJECTS_ROOT` — required project or projects directory;
- `CODEAI_PROJECTS_DEPTH` — nested discovery depth, from 1–10 (default `1`);
