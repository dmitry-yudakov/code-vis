# The software model — understanding and changing code

**Status:** Direction-setting, and one chapter of [vision.md](vision.md), which now holds the
product's main vision. This document keeps the model/map north star: one persistent semantic model,
lenses, arrangement, content and description, and the change loop. It predates
[vocabulary.md](vocabulary.md) — read *project* below as *repository*, and *workspace memory* as
*saved views*. The archived analyzer runtime it was written against is documented under
[legacy/docs/](../legacy/docs/architecture.md) ([server](../legacy/docs/server.md), [web](../legacy/docs/web.md)).
**Updated:** July 7, 2026 · refreshed August 21, 2026 · became a chapter August 29, 2026
