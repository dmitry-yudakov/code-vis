...
import { agentMessageRequestSchema, createThreadRequestSchema } from '@/lib/shared/protocol';
...
describe('provider protocol contracts', () => {
  ...
  it('does not allow the browser to override the provider for a turn', () => {
    const request = { ...ids, projectId: 'project', text: 'Explain this.', diagramAttachments: [] };
