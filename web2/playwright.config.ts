...
const e2ePort = Number(process.env.CODEAI_WEB2_E2E_PORT || 3024);
...
export default defineConfig({
  ...
  webServer: {
    ...
    env: {
      ...process.env,
      CODEAI_WEB2_PROJECTS_ROOT: path.resolve('test/fixtures/projects'),
      ...
      CODEAI_WEB2_CODEX_BIN: path.resolve('test/fixtures/not-a-real-codex'),
