...
if (mode === 'nonzero') {
  ...
  const concurrencyProbe = prompt.includes('"text":"Concurrent slot ');
  const toolDelay = cancellationProbe ? 5_000
    : concurrencyProbe ? 12_000
      : Number(process.env.CODEAI_FAKE_TOOL_DELAY_MS || 0);
